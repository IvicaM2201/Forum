	...
	while ($message = $context['get_message']())
	{
		...
		echo '
				...
				else
				{
					echo'
							<a href="', $scripturl, '?action=profile;u=', $message['member']['id'], '">
								<img src="',$settings['images_url'] ,'/theme/noavatar.gif" class="img-thumbnail display-profile" alt="*" /> 
							</a>';
				}
				...
				if ($message['can_approve'] || $context['can_reply'] || $message['can_modify'] || $message['can_remove'] || $context['can_split'] || $context['can_restore_msg'])
					echo '				
										<div class="btn-group navbar-right">
											<button type="buttonuredi" class="btn btn-morning dropdown-toggle btn-sm" data-toggle="dropdown">Uredi <span class="caret"></span></button>
...
';
	...
	$mod_buttons = array(
		...
		'sticky' => array('test' => 
		'can_sticky', 'text' => empty($context['is_sticky']) ? 'set_sticky' : 'set_nonsticky', 'image' => 'admin_sticky.gif', 'lang' => true, 'url' => $scripturl . '?action=sticky;topic=' . $context['current_topic'] . '.' . $context['start'] . ';' . $context['session_var'] . '=' . $context['session_id']),
		...
		'calendar' => array('test' => 'calendar_post', 'text' => 'calendar_link', 'image' => ' ', 'lang' => true, 'url' => $scripturl . '?action=post;calendar;msg=' . $context['topic_first_message'] . ';topic=' . $context['current_topic'] . '.0'),
	);
