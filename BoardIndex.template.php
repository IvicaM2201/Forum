        ...
        <tbody class="content" id="category_', $category['id'], '_boards">';		
			...
			foreach ($category['boards'] as $board)
			{
				...
				if ($board['new'] || $board['children_new'])
					echo '
							<img src="', $settings['images_url'], '/on.png" alt="', $txt['new_posts'], '" title="', $txt['new_posts'], '" />';
				...
				// Show some basic information about the number of posts, etc.
					...
					<td class="windowbg2 stats hidden-xs">
						<span class="postovii">', $board['posts'], '</span>
						<span class="temee">', $board['topics'], '</span>
					</td>
					<td class="windowbg2 stats hidden-xs">
				...
				if (!$modSettings['disable_avatar'])
					echo '
						<div id="avatar-u-rubrikama">
							...
							<img src="'. $modSettings['avatar_url']. '/noavatar.gif" />', '
						</div>';
				...
				{
					echo '
					<i class="fa fa-user" aria-hidden="true"></i> ', $board['last_post']['member']['link'] , '<br />
					<i class="fa fa-comments" aria-hidden="true"></i> ', $board['last_post']['link'], '<br />
					<i class="fa fa-clock-o" aria-hidden="true"></i> ', $board['last_post']['time'];
				}
				else if (!empty($board['last_post']['id']) || !$board['is_redirect'])
				{
					echo '
					<span style="font-size: 14px; color:#000; text-align: center; line-height: 50px;">Trenutno nema pokrenutih tema.</span>';
				}
				echo '
				</td>
			</tr>';
...
function template_info_center()
{
	...
	<div class="cat_bar">
				<h4 class="catbg">
					<span class="ie6_header floatleft">
					<a href="' . $scripturl . '?action=stats' . '">Statistika foruma</a>
						 </span>
				</h4>
			</div>
			...
			<div class="cat_bar">
				<h4 class="catbg">
					<span class="ie6_header floatleft">
						...
						<a href="' . $scripturl . '?action=who">AKTIVNIH KORISNIKA U ZADNJIH 90 MINUTA</a>
					</span>
				</h4>
			</div>
	...
	if (!empty($context['users_online']))
	{
		...
		if (!empty($settings['show_group_key']) && !empty($context['membergroups']))
			echo '
				<div class="grupee"><span style="font-size: 13px;">' . implode(',&nbsp;', $context['membergroups']) . '</span></div>';
	}
